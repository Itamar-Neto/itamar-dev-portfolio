...
export default function Projects() {
    ...
    return (
        ...
        >
            ...
            <div className="w-4/5 flex justify-center items-center rounded-[40px] bg-[#333333] p-[30px] relative shadow-[0_0_20px_rgba(0,0,0,0.6)] max-[860px]:p-20 overflow-hidden">
                <div
                    className="flex flex-row flex-nowrap gap-[50px]
                    overflow-x-auto justify-center w-full
                    pl-3 pr-3 pb-3
                    [&::-webkit-scrollbar]:h-2
                    [&::-webkit-scrollbar]:bg-[#525252]
